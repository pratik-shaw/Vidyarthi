      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.container}>
          ...
          >
            ...
            <Text style={styles.subtitle}>Manage institution settings and users</Text>
          </Animated.View>
          ...
          <View style={styles.optionsContainer}>
            <Animated.View style={{
              ...
              <TouchableOpacity 
                ...
                activeOpacity={0.9}
                onPress={() => navigation.navigate('CreateAdminAccount')}
              >
            ...
            <Animated.View style={{
              ...
              <TouchableOpacity 
                style={styles.optionButton} 
                activeOpacity={0.9}
                onPress={() => navigation.navigate('LoginAdminAccount')}
              >
            ...
            <Animated.View style={{ opacity: fadeAnim }}>
              <View style={styles.helperContainer}>
                <Text style={styles.helperText}>Not an administrator? </Text>
...
const styles = StyleSheet.create({
  ...
  optionButton: {
    backgroundColor: '#3A4276',  // Changed to the admin color from the login screen
    padding: 16,
    borderRadius: 10,
    alignItems: 'center',
    marginBottom: 16,
  ...
  helperLink: {
    color: '#3A4276',  // Changed to match button color
    fontSize: 14,
    fontWeight: '500',
  },
  footer: {
