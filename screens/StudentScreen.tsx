      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.container}>
          ...
          >
            ...
            <Text style={styles.subtitle}>Access your academic resources</Text>
          </Animated.View>
          ...
          <View style={styles.optionsContainer}>
            ...
            <Animated.View style={{
              ...
              <TouchableOpacity 
                style={styles.optionButton} 
                activeOpacity={0.9}
                onPress={() => navigation.navigate('LoginStudentAccount')}
              >
            ...
            <Animated.View style={{ opacity: fadeAnim }}>
              <View style={styles.helperContainer}>
                <Text style={styles.helperText}>Not a student? </Text>
