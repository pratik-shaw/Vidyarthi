...
type LoginAdminAccountScreenNavigationProp = NativeStackNavigationProp<
  RootStackParamList,
  'LoginAdminAccount'
>;
...
const LoginAdminAccountScreen = () => {
  ...
  const navigation = useNavigation<LoginAdminAccountScreenNavigationProp>();
  ...
  const handleLogin = () => {
    ...
    navigation.navigate('AdminHome'); // Navigate to Admin Home Screen on login
  };
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          <View style={styles.container}>
            ...
            >
              ...
              <Text style={styles.subtitle}>Access your administration dashboard</Text>
            </Animated.View>
